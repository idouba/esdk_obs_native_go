...
public class CIMGetClassOp extends CIMGetObjectOp {
    ...
    private final static long serialVersionUID = 8015238283052572851L;

    public CIMGetClassOp(CIMObjectPath objectPath, boolean localOnly) {
        super(objectPath, localOnly, true, false, null);
    }
