...
public class CIMAssociatorsOp extends CIMReferencesOp 
	implements EnumerableOp {

    protected String assocClass = null;
    protected String resultRole = null;

    private final static long serialVersionUID = 2049857934668585041L;

    public CIMAssociatorsOp(CIMObjectPath name,
                                String assocClass,
                                String resultClass,
                                String role,
                                String resultRole,
        ...
        super(name, resultClass, role, includeQualifiers, includeClassOrigin, 
                propertyList);
