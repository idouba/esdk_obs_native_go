...
public class CIMProperty extends CIMQualifiedElement implements Cloneable {
    ...
    public CIMDataType getType() {
        /* begin modified by fujunguang 
         * if  the DataType is invalid,then the type of this property will be set the type of value.
         */
        
	if (type != null && !type.equals(new CIMDataType(CIMDataType.INVALID))) {
	    /* end by fujunguang */
	    return type;
	}
