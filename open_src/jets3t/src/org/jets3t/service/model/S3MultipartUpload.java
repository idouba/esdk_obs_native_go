...
/**
 * Represents a S3MultipartUpload operation.
 *
 * @author James Murty
 */
public class S3MultipartUpload {
    ...
    public S3MultipartUpload(String uploadId, String bucketName, String objectKey)
    {
    ...
    public S3MultipartUpload(String uploadId, String objectKey, String storageClass,
