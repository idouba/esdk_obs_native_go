 ...
 * @author James Murty
 */
public class SS3Object extends StorageObject implements Cloneable {
     ...
     */
    public SS3Object(SS3Bucket bucket, File file) throws NoSuchAlgorithmException, IOException {
        super(file);
        if (bucket != null) {
     ...
     * @throws NoSuchAlgorithmException when this JRE doesn't support the MD5 hash algorithm
     */
    public SS3Object(File file) throws NoSuchAlgorithmException, IOException {
        super(file);
    }
     ...
     * @throws NoSuchAlgorithmException when this JRE doesn't support the MD5 hash algorithm
     */
    public SS3Object(SS3Bucket bucket, String key, String dataString) throws NoSuchAlgorithmException, IOException
    {
     ...
     * @throws NoSuchAlgorithmException when this JRE doesn't support the MD5 hash algorithm
     */
    public SS3Object(String key, String dataString) throws NoSuchAlgorithmException, IOException
    {
        super(key, dataString);
    }
     ...
     * @throws NoSuchAlgorithmException when this JRE doesn't support the MD5 hash algorithm
     */
    public SS3Object(String key, byte[] data) throws NoSuchAlgorithmException, IOException
    {
        super(key, data);
    }
     ...
     * the key name for the object.
     */
    public SS3Object(SS3Bucket bucket, String key) {
        super(key);
        if (bucket != null) {
            this.bucketName = bucket.getName();
        }
    ...
    @Override
    public Object clone() {
        SS3Object clone = new SS3Object(getKey());
    ...
    public static SS3Object[] cast(StorageObject[] objects) {
        List<SS3Object> results = new ArrayList<SS3Object>();
        for (StorageObject object: objects) {
            results.add((SS3Object)object);
        }
        return results.toArray(new SS3Object[results.size()]);
    }
