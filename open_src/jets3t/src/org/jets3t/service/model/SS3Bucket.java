 ...
 * @author James Murty
 */
public class SS3Bucket extends StorageBucket {
     ...
     */
    public SS3Bucket(String name, String location) {
        super(name, location);
    }
    ...
    public static SS3Bucket[] cast(StorageBucket[] buckets) {
        List<SS3Bucket> results = new ArrayList<SS3Bucket>();
        for (StorageBucket bucket: buckets) {
            results.add((SS3Bucket)bucket);
        }
        return results.toArray(new SS3Bucket[results.size()]);
    }
