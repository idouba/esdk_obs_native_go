...
public class ObjectUtils {
     ...
     */
    public static SS3Object createObjectForUpload(String objectKey, File dataFile,
        EncryptionUtil encryptionUtil, boolean gzipFile, BytesProgressWatcher progressWatcher)
        throws Exception
    {
        SS3Object s3Object = new SS3Object(objectKey);

        // Set object explicitly to private access by default.
        s3Object.setAcl(S3AccessControlList.REST_CANNED_PRIVATE);
        ...
        if (dataFile.isDirectory()) {
            ...
            if (!uploadFile.equals(dataFile)) {
                ...
                s3Object.addMetadata(
                    SS3Object.METADATA_HEADER_ORIGINAL_HASH_MD5,
     ...
     * exceptions could include IO failures, gzipping and encryption failures.
     */
    private static File transformUploadFile(File dataFile, SS3Object s3Object,
    ...
    public static org.jets3t.service.multithread.DownloadPackage createPackageForDownload(
        SS3Object object, File fileTarget, boolean automaticUnzip, boolean automaticDecrypt,
