...
/**
 * A simple container object to associate one of an {@link SS3Object} or a signed URL string
...
public class DownloadPackage extends org.jets3t.service.multi.DownloadPackage {
    ...
    public DownloadPackage(SS3Object object, File outputFile) {
        this(object, outputFile, false, null);
    }

    public DownloadPackage(SS3Object object, File outputFile, boolean isUnzipping,
        EncryptionUtil encryptionUtil)
    {
        super(object, outputFile, isUnzipping, encryptionUtil);
    }

    public DownloadPackage(SS3Object object, OutputStream outputStream) {
        this(object, outputStream, false, null);
    }

    public DownloadPackage(SS3Object object, OutputStream outputStream, boolean isUnzipping,
        EncryptionUtil encryptionUtil)
    {
    ...
    @Override
    public SS3Object getObject() {
        return (SS3Object) super.getObject();
    }
