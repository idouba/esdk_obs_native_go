 ...
 * <p>
 * EVENT_IN_PROGRESS events include an array of the {@link SS3Object}s that have finished downloading
 * since the last progress event was fired. These objects are available via
 * {@link #getDownloadedObjects()}.
 * <p>
 * EVENT_CANCELLED events include an array of the {@link SS3Object}s that were not downloaded
...
public class DownloadObjectsEvent extends ServiceEvent {
    ...
    public static DownloadObjectsEvent newCancelledEvent(SS3Object[] incompletedObjects, Object uniqueOperationId) {
     ...
     */
    public SS3Object[] getDownloadedObjects() throws IllegalStateException {
