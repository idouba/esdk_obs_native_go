...
/**
 * Multi-threaded service event fired by {@link S3ServiceMulti#deleteObjects(SS3Bucket, SS3Object[])}.
 * <p>
 * EVENT_IN_PROGRESS events include an array of the {@link SS3Object}s that have been deleted
 * since the last progress event was fired. These objects are available via
 * {@link #getDeletedObjects()}.
 * <p>
 * EVENT_CANCELLED events include an array of the {@link SS3Object}s that had not been deleted
...
public class DeleteObjectsEvent extends ServiceEvent {
    ...
    public static DeleteObjectsEvent newInProgressEvent(ThreadWatcher threadWatcher,
        SS3Object[] deletedObjects, Object uniqueOperationId)
    {
    ...
    public static DeleteObjectsEvent newCancelledEvent(SS3Object[] remainingObjects, Object uniqueOperationId) {
     ...
     */
    public SS3Object[] getDeletedObjects() throws IllegalStateException {
