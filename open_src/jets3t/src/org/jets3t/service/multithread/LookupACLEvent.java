...
/**
 * Multi-threaded service event fired by {@link S3ServiceMulti#getObjectACLs(SS3Bucket, SS3Object[])}.
 * <p>
 * EVENT_IN_PROGRESS events include an array of the {@link SS3Object}s whose ACLs have been retrieved
 * since the last progress event was fired. These objects are available via
 * {@link #getObjectsWithACL()}.
 * <p>
 * EVENT_CANCELLED events include an array of the {@link SS3Object}s whose ACLs had not been retrieved
...
public class LookupACLEvent extends ServiceEvent {
    ...
    public static LookupACLEvent newCancelledEvent(SS3Object[] incompletedObjects,
     ...
     */
    public SS3Object[] getObjectsWithACL() throws IllegalStateException {
