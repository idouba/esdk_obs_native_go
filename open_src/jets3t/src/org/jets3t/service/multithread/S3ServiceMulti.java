...
public class S3ServiceMulti {
     ...
     * true if all the threaded tasks completed successfully, false otherwise.
     */
    public boolean createBuckets(final SS3Bucket[] buckets) {
            ...
            this.s3Service.getJetS3tProperties(), true)
        {
            ...
            public void fireProgressEvent(ThreadWatcher threadWatcher, List completedResults) {
                ...
                SS3Bucket[] completedBuckets = (SS3Bucket[]) completedResults
                    .toArray(new SS3Bucket[completedResults.size()]);
                fireServiceEvent(CreateBucketsEvent.newInProgressEvent(threadWatcher, completedBuckets, uniqueOperationId));
            }
            @Override
            public void fireCancelEvent() {
                SS3Bucket[] incompletedBuckets = (SS3Bucket[]) incompletedBucketList
                    .toArray(new SS3Bucket[incompletedBucketList.size()]);
                success[0] = false;
    ...
    public boolean copyObjects(final String sourceBucketName, final String destinationBucketName,
        final String[] sourceObjectKeys, final SS3Object[] destinationObjects, boolean replaceMetadata)
    {
            ...
            this.s3Service.getJetS3tProperties(), true)
        {
            ...
            @Override
            public void fireCancelEvent() {
                SS3Object[] incompletedObjects = (SS3Object[]) incompletedObjectsList
                    .toArray(new SS3Object[incompletedObjectsList.size()]);
                success[0] = false;
     ...
     * true if all the threaded tasks completed successfully, false otherwise.
     */
    public boolean putObjects(final SS3Bucket bucket, final SS3Object[] objects) {
        final List incompletedObjectsList = new ArrayList();
            ...
            this.s3Service.getJetS3tProperties(), false)
        {
            ...
            public void fireProgressEvent(ThreadWatcher threadWatcher, List completedResults) {
                incompletedObjectsList.removeAll(completedResults);
                SS3Object[] completedObjects = (SS3Object[]) completedResults
                    .toArray(new SS3Object[completedResults.size()]);
     ...
     * true if all the threaded tasks completed successfully, false otherwise.
     */
    public boolean deleteObjects(final SS3Bucket bucket, String[] objectKeys) {
        SS3Object objects[] = new SS3Object[objectKeys.length];
        for (int i = 0; i < objects.length; i++) {
            objects[i] = new SS3Object(objectKeys[i]);
        }
     ...
     * true if all the threaded tasks completed successfully, false otherwise.
     */
    public boolean deleteObjects(final SS3Bucket bucket, final SS3Object[] objects) {
            ...
            this.s3Service.getJetS3tProperties(), true)
        {
            ...
            public void fireProgressEvent(ThreadWatcher threadWatcher, List completedResults) {
                ...
                SS3Object[] deletedObjects = (SS3Object[]) completedResults
                    .toArray(new SS3Object[completedResults.size()]);
                fireServiceEvent(DeleteObjectsEvent.newInProgressEvent(threadWatcher, deletedObjects, uniqueOperationId));
            }
            @Override
            public void fireCancelEvent() {
                SS3Object[] remainingObjects = (SS3Object[]) objectsToDeleteList
                    .toArray(new SS3Object[objectsToDeleteList.size()]);
                success[0] = false;
     ...
     * true if all the threaded tasks completed successfully, false otherwise.
     */
    public boolean getObjects(SS3Bucket bucket, SS3Object[] objects) {
     ...
     * true if all the threaded tasks completed successfully, false otherwise.
     */
    public boolean getObjects(final SS3Bucket bucket, final String[] objectKeys) {
            ...
            this.s3Service.getJetS3tProperties(), false)
        {
            ...
            public void fireCancelEvent() {
                ...
                while (iter.hasNext()) {
                    ...
                    cancelledObjectsList.add(new SS3Object(key));
                }
                SS3Object[] cancelledObjects = (SS3Object[]) cancelledObjectsList
                    .toArray(new SS3Object[cancelledObjectsList.size()]);
                success[0] = false;
     ...
     * true if all the threaded tasks completed successfully, false otherwise.
     */
    public boolean getObjectsHeads(SS3Bucket bucket, SS3Object[] objects) {
        String[] objectKeys = new String[objects.length];
        for (int i = 0; i < objects.length; i++) {
            objectKeys[i] = objects[i].getKey();
        }
     ...
     * true if all the threaded tasks completed successfully, false otherwise.
     */
    public boolean getObjectsHeads(final SS3Bucket bucket, final String[] objectKeys) {
        final List pendingObjectKeysList = new ArrayList();
        final Object uniqueOperationId = new Object(); // Special object used to identify this operation.
        final boolean[] success = new boolean[] {true};
     ...
     * true if all the threaded tasks completed successfully, false otherwise.
     */
    public boolean getObjectACLs(final SS3Bucket bucket, final SS3Object[] objects) {
            ...
            this.s3Service.getJetS3tProperties(), true)
        {
            ...
            @Override
            public void fireCancelEvent() {
                SS3Object[] cancelledObjects = (SS3Object[]) pendingObjectsList
                    .toArray(new SS3Object[pendingObjectsList.size()]);
                success[0] = false;
     ...
     * true if all the threaded tasks completed successfully, false otherwise.
     */
    public boolean putACLs(final SS3Bucket bucket, final SS3Object[] objects) {
        final List pendingObjectsList = new ArrayList();
        final Object uniqueOperationId = new Object(); // Special object used to identify this operation.
        final boolean[] success = new boolean[] {true};
     ...
     * @throws S3ServiceException
     */
    public boolean downloadObjects(final SS3Bucket bucket,
        final DownloadPackage[] downloadPackages) throws S3ServiceException
    {
        ...
        final SS3Object[] objects = new SS3Object[downloadPackages.length];
        for (int i = 0; i < runnables.length; i++) {
            ...
            this.s3Service.getJetS3tProperties(), false)
        {
            ...
            @Override
            public void fireCancelEvent() {
                SS3Object[] incompleteObjects = (SS3Object[]) incompleteObjectDownloadList
                    .toArray(new SS3Object[incompleteObjectDownloadList.size()]);
                success[0] = false;
     ...
     * {@link #downloadObjects(SS3Bucket, DownloadPackage[])}
     * <p>
     * The maximum number of threads is controlled by the JetS3t configuration property
     * <tt>s3service.max-thread-count</tt>.
     * <p>
    ...
    public boolean getObjects(final String[] signedGetURLs) throws MalformedURLException, UnsupportedEncodingException {
        ...
        for (int i = 0; i < runnables.length; i++) {
            ...
            SS3Object object = ServiceUtils.buildObjectFromUrl(
                url.getHost(), url.getPath(), s3Service.getEndpoint());
     ...
     * true if all the threaded tasks completed successfully, false otherwise.
     */
    public boolean putObjectsACLs(final String[] signedURLs, final S3AccessControlList acl)
    ...
    public boolean putObjects(final SignedUrlAndObject[] signedPutUrlAndObjects) {
        ...
        SS3Object objects[] = new SS3Object[signedPutUrlAndObjects.length];
    ...
    private class PutACLRunnable extends AbstractRunnable {
        private SS3Bucket bucket = null;
        private SS3Object s3Object = null;
        private String signedUrl = null;
        private S3AccessControlList signedUrlAcl = null;
        private Object result = null;

        public PutACLRunnable(SS3Bucket bucket, SS3Object s3Object) {
            this.bucket = bucket;
            this.s3Object = s3Object;
        }

        public PutACLRunnable(String signedAclUrl, S3AccessControlList signedUrlAcl) {
    ...
    private class GetACLRunnable extends AbstractRunnable {
        ...
        public GetACLRunnable(SS3Bucket bucket, SS3Object object) {
            this.bucket = bucket;
            this.object = object;
        }
        ...
        public void run() {
            try {
                if (signedAclUrl == null) {
                    S3AccessControlList acl = s3Service.getObjectAcl(bucket, object.getKey());
                    object.setAcl(acl);
                    result = object;
                } else {
                    SignedUrlHandler handler = s3Service;
                    S3AccessControlList acl = handler.getObjectAclWithSignedUrl(signedAclUrl);
    ...
    private class DeleteObjectRunnable extends AbstractRunnable {
        ...
        public DeleteObjectRunnable(SS3Bucket bucket, SS3Object object) {
    ...
    private class CreateBucketRunnable extends AbstractRunnable {
        ...
        public CreateBucketRunnable(SS3Bucket bucket) {
            this.bucket = bucket;
        }
        ...
        public void run() {
            try {
                ...
                result = new S3ObjectsChunk(
                    prefix, delimiter,
                    (SS3Object[]) allObjects.toArray(new SS3Object[allObjects.size()]),
    ...
    private class CreateObjectRunnable extends AbstractRunnable {
        ...
        public CreateObjectRunnable(SS3Bucket bucket, SS3Object s3Object, BytesProgressWatcher progressMonitor) {
            this.bucket = bucket;
            this.s3Object = s3Object;
    ...
    private class GetObjectRunnable extends AbstractRunnable {
        ...
        public GetObjectRunnable(SS3Bucket bucket, String objectKey, boolean headOnly) {
    ...
    private class DownloadObjectRunnable extends AbstractRunnable {
        ...
        public DownloadObjectRunnable(SS3Bucket bucket, String objectKey, DownloadPackage downloadPackage,
