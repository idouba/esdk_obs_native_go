...
/**
 * Multi-threaded service event fired by {@link S3ServiceMulti#createBuckets(SS3Bucket[])}.
 * <p>
 * EVENT_IN_PROGRESS events include an array of the {@link SS3Bucket}s that have been created
 * since the last progress event was fired. These objects are available via
 * {@link #getCreatedBuckets()}.
 * <p>
 * EVENT_CANCELLED events include an array of the {@link SS3Bucket}s that had not been created
...
public class CreateBucketsEvent extends ServiceEvent {
    ...
    public static CreateBucketsEvent newInProgressEvent(ThreadWatcher threadWatcher,
        SS3Bucket[] completedBuckets, Object uniqueOperationId)
    {
    ...
    public static CreateBucketsEvent newCancelledEvent(SS3Bucket[] incompletedBuckets, Object uniqueOperationId) {
    ...
    private void setBuckets(SS3Bucket[] buckets) {
     ...
     */
    public SS3Bucket[] getCreatedBuckets() throws IllegalStateException {
     ...
     */
    public SS3Bucket[] getCancelledBuckets() throws IllegalStateException {
