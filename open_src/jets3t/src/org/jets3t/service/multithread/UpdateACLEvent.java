 ...
 * <p>
 * EVENT_IN_PROGRESS events include an array of the {@link SS3Object}s that have had their ACLs updated
 * since the last progress event was fired. These objects are available via
 * {@link #getObjectsWithUpdatedACL()}.
 * <p>
 * EVENT_CANCELLED events include an array of the {@link SS3Object}s that did not have their ACLs updated
...
public class UpdateACLEvent extends ServiceEvent {
    ...
    public static UpdateACLEvent newCancelledEvent(SS3Object[] incompletedObjects, Object uniqueOperationId) {
     ...
     */
    public SS3Object[] getObjectsWithUpdatedACL() throws IllegalStateException {
