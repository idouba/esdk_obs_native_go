...
public class S3ServiceSimpleMulti {
     ...
     * @throws S3ServiceException
     */
    public SS3Bucket[] createBuckets(final SS3Bucket[] buckets) throws S3ServiceException {
        ...
        throwError(adaptor);
        return (SS3Bucket[]) bucketList.toArray(new SS3Bucket[bucketList.size()]);
    }
     ...
     * @throws S3ServiceException
     */
    public SS3Object[] putObjects(final SS3Bucket bucket, final SS3Object[] objects) throws S3ServiceException {
        ...
        throwError(adaptor);
        return (SS3Object[]) objectList.toArray(new SS3Object[objectList.size()]);
    }
     ...
     * @throws S3ServiceException
     */
    public void deleteObjects(final SS3Bucket bucket, final SS3Object[] objects) throws S3ServiceException {
        final List objectList = new ArrayList();
        S3ServiceEventAdaptor adaptor = new S3ServiceEventAdaptor() {
            @Override
     ...
     * {@link SS3Object#getDataInputStream()}.
     *
     * @param bucket
     ...
     * @throws S3ServiceException
     */
    public SS3Object[] getObjects(SS3Bucket bucket, SS3Object[] objects) throws S3ServiceException {
     ...
     * @throws S3ServiceException
     */
    public SS3Object[] getObjects(final SS3Bucket bucket, final String[] objectKeys) throws S3ServiceException {
     ...
     * @throws S3ServiceException
     */
    public SS3Object[] getObjectsHeads(SS3Bucket bucket, SS3Object[] objects) throws S3ServiceException {
     ...
     * @throws S3ServiceException
     */
    public SS3Object[] getObjectsHeads(final SS3Bucket bucket, final String[] objectKeys) throws S3ServiceException {
        final List objectList = new ArrayList();
        S3ServiceEventAdaptor adaptor = new S3ServiceEventAdaptor() {
            @Override
     ...
     * @throws S3ServiceException
     */
    public SS3Object[] getObjectACLs(final SS3Bucket bucket, final SS3Object[] objects) throws S3ServiceException {
        final List objectList = new ArrayList();
        S3ServiceEventAdaptor adaptor = new S3ServiceEventAdaptor() {
            @Override
     ...
     * @throws S3ServiceException
     */
    public SS3Object[] putACLs(final SS3Bucket bucket, final SS3Object[] objects) throws S3ServiceException {
        final List objectList = new ArrayList();
        S3ServiceEventAdaptor adaptor = new S3ServiceEventAdaptor() {
            @Override
     ...
     * @throws S3ServiceException
     */
    public void downloadObjects(final SS3Bucket bucket, final DownloadPackage[] downloadPackages) throws S3ServiceException {
        S3ServiceEventAdaptor adaptor = new S3ServiceEventAdaptor();
        (new S3ServiceMulti(s3Service, adaptor)).downloadObjects(bucket, downloadPackages);
        throwError(adaptor);
    }
