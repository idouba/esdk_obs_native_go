 ...
 *
 */
public class S3GroupGrantee implements S3GranteeInterface {
    /**
     * The group of all users, represented in S3 by the URI:
     * http://acs.amazonaws.com/groups/global/AllUsers
     */
    public static final S3GroupGrantee ALL_USERS = new S3GroupGrantee("http://acs.amazonaws.com/groups/global/AllUsers");

    /**
     * The group of authenticated users, represented in S3 by the URI:
     * http://acs.amazonaws.com/groups/global/AuthenticatedUsers
     */
    public static final S3GroupGrantee AUTHENTICATED_USERS = new S3GroupGrantee("http://acs.amazonaws.com/groups/global/AuthenticatedUsers");

    /**
     * The group of Bucket Log delivery users, represented in S3 by the URI:
     * http://acs.amazonaws.com/groups/s3/LogDelivery
     */
    public static final S3GroupGrantee LOG_DELIVERY = new S3GroupGrantee("http://acs.amazonaws.com/groups/s3/LogDelivery");

    protected String id = null;

    public S3GroupGrantee() {
    }
     ...
     * @param groupUri
     */
    public S3GroupGrantee(String groupUri) {
        this.id = groupUri;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof S3GroupGrantee) {
            return id.equals(((S3GroupGrantee)obj).id);
        }
        return false;
    }
