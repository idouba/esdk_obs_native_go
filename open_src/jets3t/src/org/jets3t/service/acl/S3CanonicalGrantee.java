 ...
 *
 */
public class S3CanonicalGrantee implements S3GranteeInterface {
     ...
     * @param identifier
     */
    public S3CanonicalGrantee(String identifier) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof S3CanonicalGrantee) {
            S3CanonicalGrantee canonicalGrantee = (S3CanonicalGrantee) obj;
