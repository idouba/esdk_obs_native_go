...
/**
 * Represents an access permission, as granted to grantees in an {@link S3AccessControlList}.
...
public class S3Permission {
    public static final S3Permission PERMISSION_FULL_CONTROL = new S3Permission("FULL_CONTROL");
    public static final S3Permission PERMISSION_READ = new S3Permission("READ");
    public static final S3Permission PERMISSION_WRITE = new S3Permission("WRITE");
    public static final S3Permission PERMISSION_READ_ACP = new S3Permission("READ_ACP");
    public static final S3Permission PERMISSION_WRITE_ACP = new S3Permission("WRITE_ACP");

    private String permissionString = "";

    private S3Permission(String permissionString) {
     ...
     */
    public static S3Permission parsePermission(String str) {
    ...
    public boolean equals(Object obj) {
        return (obj instanceof S3Permission) && toString().equals(obj.toString());
    }
