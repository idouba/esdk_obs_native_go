 ...
 * <p>
 * EVENT_IN_PROGRESS events include an array of the {@link SS3Object}s that have been created
 * since the last progress event was fired. These objects are available via
 * {@link #getCompletedUploads()}.
 * <p>
 * EVENT_CANCELLED events include an array of the {@link SS3Object}s that had not been created
...
public class MultipartCompletesEvent extends ServiceEvent {
    private S3MultipartUpload[] incompleteUploads = null;
    ...
    public static MultipartCompletesEvent newCancelledEvent(S3MultipartUpload[] incompletedUploads,
    ...
    private void setIncompleteUploads(S3MultipartUpload[] uploads) {
    ...
    /**
     * @return
     * the {@link S3MultipartUpload}s that have been completed since the last progress event was fired.
    ...
    /**
     * @return
     * the {@link S3MultipartUpload}s that were not completed before the operation was cancelled.
     * @throws IllegalStateException
     * cancelled objects are only available from EVENT_CANCELLED events.
     */
    public S3MultipartUpload[] getCancelledUploads() throws IllegalStateException {
