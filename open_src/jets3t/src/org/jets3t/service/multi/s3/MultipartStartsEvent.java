...
public class MultipartStartsEvent extends ServiceEvent {
    private S3MultipartUpload[] completedMultipartUploads = null;
    ...
    public static MultipartStartsEvent newInProgressEvent(ThreadWatcher threadWatcher,
        S3MultipartUpload[] completedMultipartUploads, Object uniqueOperationId)
    {
    ...
    private void setCompletedUploads(S3MultipartUpload[] uploads) {
        this.completedMultipartUploads = uploads;
    }

    /**
     * @return
     * the {@link S3MultipartUpload}s that have been started since the last progress event was fired.
     * @throws IllegalStateException
     * created objects are only available from EVENT_IN_PROGRESS events.
     */
    public S3MultipartUpload[] getStartedUploads() throws IllegalStateException {
