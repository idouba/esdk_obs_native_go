...
public abstract class StorageService {
     ...
     * @throws ServiceException
     */
    public S3AccessControlList getObjectAcl(String bucketName, String objectKey)
        throws ServiceException
    {
        return getObjectAclImpl(bucketName, objectKey, null);
    }
    
    public S3AccessControlList getObjectAcl(String bucketName, String objectKey, String versionId)
        throws ServiceException
    {
